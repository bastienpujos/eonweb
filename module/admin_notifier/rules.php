...
<div id="page-wrapper">
	...
	<form id="form-rules" action="./rules.php" method="POST" name="form">
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<input class="form-control" type="textbox" name="rule_name" value="<?php echo $rule_name; ?>" autofocus>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<input class="form-control" type="textbox" name="type" value="<?php echo $rule_type; ?>" readonly>
			</div>
		</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<div class="form-group input-group">
					<input class="form-control" id="rule_contact1" type="textbox" name="rule_contact" onFocus='$(this).autocomplete({source: <?php get_field("contact",false,"contact_group"); ?>})'>
					<span class="input-group-btn">
						<input class="btn btn-success" id="rule_contact_button" type="button" class="button" value="<?php echo getLabel("action.add");?>">
						<input class="btn btn-danger" id="rule_contact_button_del" type="button" class="button" value="<?php echo getLabel("action.clear");?>">
					</span>
				</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<div class="form-group input-group">
					<input class="form-control" id="rule_host1" type="textbox" name="rule_host" onFocus='$(this).autocomplete({source: <?php echo get_field("host",false,"hostgroup");?>})'>
					<span class="input-group-btn">
						<input class="btn btn-success" id="rule_host_button" type="button" class="button" value="<?php echo getLabel("action.add");?>">
						<input class="btn btn-danger" id="rule_host_button_del" type="button" class="button" value="<?php echo getLabel("action.clear");?>">
					</span>
				</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<div class="form-group input-group">
					<input class="form-control" id="rule_service2" type="textbox" name="rule_service1" onFocus='$(this).autocomplete({source: <?php echo get_field("service",false,"service_group");?>})'>
					<span class="input-group-btn">
						<input class="btn btn-success" id="rule_service_button" type="button" class="button" value="<?php echo getLabel("action.add");?>">
						<input class="btn btn-danger" id="rule_service_button_del" type="button" class="button" value="<?php echo getLabel("action.clear");?>">
					</span>
				</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<input class="form-control" type="textbox" name="rule_notification" value="<?php if($rule_notification!="-"){ echo $rule_notification; } ?>">
			</div>
		</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<input class="form-control" type="textbox" id="rule_timeperiod" name="rule_timeperiod" value="<?php echo $rule_timeperiod; ?>" onFocus='$(this).autocomplete({source: <?php echo get_field("timeperiods");?>})'>
			</div>
		</div>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<div class="form-group input-group">
					<input class="form-control" type="textbox" id="rule_method" name="rule_method" value="<?php if(isset($rule_method)){echo $rule_method;} ?>" onFocus='$(this).autocomplete({source: <?php echo get_field("methods",$rule_type);?>})'>
					<span class="input-group-btn">
						<input class="btn btn-success" id="rule_method_button" type="button" class="button" value="<?php echo getLabel("action.add");?>">
						<input class="btn btn-danger" id="rule_method_button_del" type="button" class="button" value="<?php echo getLabel("action.clear");?>">
					</span>
				</div>
				<select class="form-control" id="methods" name="methods[]" class="select" size=4 multiple="multiple">
				<?php 
		...
		<div class="form-group">
			...
			?>
			<input class="btn btn-default" class="button" type="button" name="back" value="<?php echo getLabel("action.cancel"); ?>" onclick="location.href='index.php'">
		</div>
	</form>
</div>
