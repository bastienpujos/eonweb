...
<div id="page-wrapper">
	...
	<form action="./contact.php" method="POST" name="form">
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<input class="form-control" id="contact" type="textbox" name="contact" value="<?php echo $contact; ?>" onFocus='$(this).autocomplete(<?php echo get_field("contact",0,"contact_group");?>)'>
		...
		<div class="form-group">
			...
			?>
			<input class="btn btn-default" class="button" type="button" name="back" value="<?php echo getLabel("action.cancel"); ?>" onclick="location.href='index.php?action=contacts'">
		</div>
	</form>
</div>
