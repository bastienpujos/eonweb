...
<div id="page-wrapper">
	...
	<form action="./timeperiods.php" method="POST" name="form">
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				<input class="form-control" type="textbox" name="timeperiod_name" value="<?php echo $timeperiod_name; ?>" autofocus>
		...
		<div class="row form-group">
			...
			<div class="col-md-9">
				...
				<select class="form-control" id="timeperiods" name="timeperiods[]" class="select" size=4 multiple="multiple">
				<?php 
		...
		<div class="form-group">
			...
			?>
			<input class="btn btn-default" class="button" type="button" name="back" value="<?php echo getLabel("action.cancel"); ?>" onclick="location.href='index.php?action=timeperiods'">
		</div>
	</form>
