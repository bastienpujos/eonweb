			...
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<textarea class="form-control  textarea" rows="20" id="notifier1" name="maj" scrolling="no" disabled><?php print file_get_contents($path_notifier_methods); ?></textarea>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="row form-group">
			<div class="col-md-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<textarea class="form-control  textarea" rows="20" id="notifier" name="maj" scrolling="no" disabled><?php print file_get_contents($path_notifier_rules); ?></textarea>
					</div>
				</div>
			</div>
		</div>
